  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-neutral-800/70">
        <div className="relative w-full h-full mx-auto my-6 md:w-4/6 lg:3/6 xl:w-2/5 lg:h-auto md:h-auto">
          {/* CONTENT */}
          <div
            className={`
                    translate
          ...
          >
            <div className="relative flex flex-col w-full h-full bg-white border-0 rounded-lg shadow-lg outline-none translate lg:h-auto md:h-auto focus:outline-none">
              ...
              <div className="relative flex items-center justify-center p-6 rounded-t border-b-[1px]">
                <button
                  onClick={handleClose}
                  className="absolute p-1 transition-none border-0 hover:opacity-70 left-9"
                >
                  <IoMdClose size={18} />
                </button>
